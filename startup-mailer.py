...
# Change this
to = 'your.email@mail.com' # Email to send to. (CAN BE ANYTHING)

# Leave this alone
gmail_user = 'aspire.inspire.2016@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'anteater' # Gmail password.
